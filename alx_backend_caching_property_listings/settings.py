...
SECRET_KEY = 'django-insecure-b#0g0n-qa5$xn70qy396ym82vlk08gi5dpnx)kxxn&k(3k=e_p'
...
# PostgreSQL configuration (commented out for migration creation)
# DATABASES = {
#     'default': {
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'redis://localhost:6379/1',  # Use 'redis://redis:6379/1' if running Django in Docker
        'OPTIONS': {
